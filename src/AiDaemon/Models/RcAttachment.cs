...
/// </summary>
/// <param name="PsPid">cmd.exe launcher PID. Used by CleanupAsync to <c>Kill(entireProcessTree)</c>. (Named PsPid for historical reasons; was the PowerShell PID before the cmd.exe switch.)</param>
